...
<title>Editar Role: <%=role.getId()%></title>
...
<div class="titulo">
	...
	<form action="/roles/edit" method="post">
		<label>Edite el Rol</label> <input type="text" name="IdRol" placeholder="Ingrese el Rol" 
			value="<%=role.getNombre()%>" required> <br> <br><br> 
		


		<br> <input type="hidden" name="id" value="<%=role.getId()%>">
		<input type="submit" value="Editar">
	</form>
	<center>
		<a href="/roles"><img src="/lista.png" width="50" height="50"></a>
	</center>
</body>
</html>